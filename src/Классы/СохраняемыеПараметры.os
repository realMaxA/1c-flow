...
Функция Конструктор_СтруктураПараметров(ЧитатьИмеющийсяКонфиг = Истина) Экспорт
	...
	СтруктураПараметров.Вставить("ПутьКОсновномуХранилищу", "");
	СтруктураПараметров.Вставить("ПользовательОсновногоХранилища", "");
	СтруктураПараметров.Вставить("ПарольОсновногоХранилища", "");	
