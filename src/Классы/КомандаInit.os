...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды) Экспорт
	...
	ПутьКРепозиторию               = ПараметрыКоманды["ПутьКРепозиторию"];
	...
	Команда.УстановитьРабочийКаталог(ПутьКРепозиторию);
	...
	Если Не ЭтоРепозитарийGit Тогда
		Лог.Ошибка(НСтр("ru = 'Рабочий каталог не является каталогом git-репозитория'"));
